...
#print(set1[0]) #error 'set' object does not support
for element in set1:
        print(element)
print(1 in set1)
print(6 in set1)
...
set1.clear()
print(set1)
id_numbers={50392898,50239489,50334849,50239478,50239484}
id_numbers.pop()
print(id_numbers)

#sets do not print in order all the time
#tuples##################################
...
print(tuple4[3])
print(tuple4[-1])
#u can use indexes in tuples but not with sets
